...
namespace ZipCo.Users.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201029041234_add_more_columns_to_account_table")]
    partial class add_more_columns_to_account_table
    {
            ...
            modelBuilder.Entity("ZipCo.Users.Domain.Entities.AccountSignUp.AccountSignUpStrategy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTime(2020, 10, 29, 4, 12, 33, 888, DateTimeKind.Utc).AddTicks(5179),
                            IsDefault = true,
                            ModifiedOn = new DateTime(2020, 10, 29, 4, 12, 33, 888, DateTimeKind.Utc).AddTicks(5712),
