...
namespace ZipCo.Users.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201030041637_add-column-types-for-balance")]
    partial class addcolumntypesforbalance
    {
            ...
            modelBuilder.Entity("ZipCo.Users.Domain.Entities.AccountSignUp.AccountSignUpStrategy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTime(2020, 10, 30, 4, 16, 36, 727, DateTimeKind.Utc).AddTicks(8849),
                            IsDefault = true,
                            ModifiedOn = new DateTime(2020, 10, 30, 4, 16, 36, 727, DateTimeKind.Utc).AddTicks(9927),
