...
namespace ZipCo.Users.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201030100040_add_mote_column_types-Change")]
    partial class add_mote_column_typesChange
    {
            ...
            modelBuilder.Entity("ZipCo.Users.Domain.Entities.AccountSignUp.AccountSignUpStrategy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedOn = new DateTime(2020, 10, 30, 10, 0, 40, 353, DateTimeKind.Utc).AddTicks(7129),
                            IsDefault = true,
                            ModifiedOn = new DateTime(2020, 10, 30, 10, 0, 40, 353, DateTimeKind.Utc).AddTicks(7457),
